        ...
        <View style={styles.container}>
            ...
            <View style={styles.flexRow2}>
                ...
                <View style={{ width: '80%' }}>
                    ...
                    <CustomText numberOfLines={2} variant='h8' fontFamily={Fonts.Regular}>{details?.address || '-------'}</CustomText>
                </View>
            </View>
            ...
            <View style={styles.flexRow2}>
                ...
                <View style={{ width: '80%' }}>
                    ...
                    <CustomText numberOfLines={2} variant='h8' fontFamily={Fonts.Regular}>Receiver's contact no.</CustomText>
                </View>
            </View>
